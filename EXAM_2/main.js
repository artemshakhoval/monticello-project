...
$(".item__link").on('click', function() {
    let wrapperSection = $(this).attr('href')
    let wrapperSectionPosition = $(wrapperSection).offset().top
    $('html, body').animate({
  ...
  $(".arrow__transition").on('click', function() {
    let headerArrow = $(this).attr('href')
    let wrapperGalleryPosition = $(headerArrow).offset().top
    $('html, body').animate({
...
initMap = function() {
  let myLatLng = { lat: 46.96092520489327, lng: 32.020104540237384 };
